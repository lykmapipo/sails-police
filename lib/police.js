...
var rememberable = require(path.join(morphsPath, 'rememberable'));
...
//return remember me authentication middleware
Police.prototype.rememberMe = function() {
    return passport.authenticate('police-remember-me');
};
...
Police.prototype.middlewares = {
    ...
    mixin: function(middlewares) {
        ...
        middlewares.middleware = _.extend(previousMiddlewares.middleware, {
            ...
            //police middleware to add
            //passportjs remember me 
            //authentication strategy
            policeRememberMe: exports.rememberMe(),
        });

        //patching sails middleware order and add
        //police middlewares before router in the middleware order
        previousOrder.splice(indexOfRouter, 0, 'policeLocals', 'policeInit', 'policeSession', 'policeRememberMe');
