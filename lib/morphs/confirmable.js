...
Confirmable.prototype.bindModelGenerateConfirmationToken = function() {
    ...
    function generateConfirmationToken(confirmable, callback) {
    ...
    self.model.generateConfirmationToken = generateConfirmationToken;
};
