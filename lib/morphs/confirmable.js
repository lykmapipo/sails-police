...
Confirmable.prototype.apply = function(model) {
    ...
    this._mixin.attributes(model);

    //mix instance methods
    this._mixin.instanceMethods(model);

    //mix static methods
    this._mixin.staticMethods();
...
Confirmable.prototype._mixin = {
    ...
    instanceMethods: function(model) {
        ...
        Helpers.mixAttributes(model, {
            generateConfirmationToken: exports._generateConfirmationToken
        });

        //bind send confirmation
        //as model instance method
        Helpers.mixAttributes(model, {
            sendConfirmationEmail: exports._sendConfirmationEmail
        });
    },
    ...
    staticMethods: function(model) {
        ...
        Helpers.mixStaticMethod(model, 'confirm', exports._confirm);
    }
};
