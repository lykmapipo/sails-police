        ...
        async
            .waterfall(
                [
                    ...
                    function(next) {
                        Registerable
                            .encryptPassword(subject.password, next);
                    },
                    //set password to encrypted one
                    function(passwordHash, next) {
                        subject.password = passwordHash;
                        next(null, subject);
                    },
                    ...
                    function(confirmationToken, next) {
                        ...
                        subject.confirmationToken = confirmationToken;

                        //set confirmation expiration date
                        var confirmationTokenExpiryAt =
                            moment().add(3, 'days');

                        subject.confirmationTokenExpiryAt =
